//
//  Mission3ExplanationViewController.m
//  EnRoute
//
...
@interface Mission3ExplanationViewController ()

@end

@implementation Mission3ExplanationViewController
...
- (void)loadView{
    ...
    self.view = [[Mission3ExplanationView alloc] initWithFrame:bounds];
}
...
- (void)viewDidLoad
{
    ...
    [self.view.btnstart addTarget:self action:@selector(startOpdracht:) forControlEvents:UIControlEventTouchUpInside];
}
